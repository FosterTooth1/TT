...
void actualizar_cumulo(cumulo *c, double **distancias, int longitud_permutacion, float prob_pbest, float prob_gbest , float prob_heuristica, float prob_aleatorio);
//Actualizar la ruta y el fitness de una particula tomando en cuenta la mejor ruta global y la mejor ruta personal
void actualizar_particula(particula *particula, int* gbest, double **distancias, int longitud_permutacion, float prob_pbest, float prob_gbest, float prob_heuristica, float prob_aleatorio);
