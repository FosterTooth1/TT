...
// Recibe el tamaño de la solución y la longitud de la permutación
// Devuelve un puntero a la solución creada
...
// Función para crear una permutación aleatoria
// Recibe un puntero a la solución y la longitud de la permutación
...
// Función para calcular el fitness de una ruta
// Recibe un puntero a la ruta, la matriz de distancias y el número de ciudades
// Devuelve el valor del fitness (distancia total)
...
// Función para generar un vecino mediante una operación 2-opt
// Recibe un puntero a la ruta actual, un puntero a la ruta vecino y el número de ciudades
// No devuelve nada (todo se hace por referencia)
...
// Función para calcular la probabilidad de aceptación en el recocido simulado
// Recibe el fitness actual, el fitness del vecino y la temperatura
// Devuelve la probabilidad de aceptación (valor entre 0 y 1)
...
// Función para liberar la memoria de una solución
