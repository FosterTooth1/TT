...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    // Evento click para rehacer optimización
    btnRehacer.addEventListener("click", async () => {
        ...
        try {
            ...
            // Llamada al servidor para regenerar la ruta
    ...
    // Manejo de modal para detalles y eliminación
...
// Función para cargar rutas del usuario
async function cargarRutasUsuario() {
    ...
    // Llamada al servidor para obtener rutas
    try {
