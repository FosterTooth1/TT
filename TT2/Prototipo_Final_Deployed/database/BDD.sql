-- Crear la base de datos (Modificar el nombre según sea necesario)
...
-- Tabla "Ruta"
-- Almacena las rutas guardadas por los usuarios
CREATE TABLE Ruta (
    id_ruta INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario INT NOT NULL,
    destinos JSON NOT NULL,
    CONSTRAINT fk_ruta_usuario FOREIGN KEY (id_usuario) REFERENCES Usuario(id_usuario) ON DELETE CASCADE
);


-- Inserciones de ejemplo en "Usuario"
-- NOTA: Las contraseñas son hashes de ejemplo
