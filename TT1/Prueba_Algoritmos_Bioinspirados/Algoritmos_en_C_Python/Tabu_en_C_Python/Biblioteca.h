...
// Estructura para almacenar movimientos tabú
typedef struct {
    int i;          // Posición i del movimiento 2-opt
    int j;          // Posición j del movimiento 2-opt
    int iteracion;  // Iteración en que se agregó
} Tabu;
